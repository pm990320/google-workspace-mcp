...
// --- Initialization ---
// Multi-account initialization happens at server startup
...
// --- Helper to get Docs client for a specific account ---
...
// --- Helper to get Drive client for a specific account ---
...
// --- Helper to get Sheets client for a specific account ---
...
// --- Helper to get Gmail client for a specific account ---
...
// --- Helper to get Calendar client for a specific account ---
...
// --- Helper to get Slides client for a specific account ---
...
// --- Helper to get Forms client for a specific account ---
...
function convertParagraphToMarkdown(paragraph: any): string {
  ...
  if (paragraph.bullet) {
    isList = true;
    // listType = paragraph.bullet.listId ? 'bullet' : 'bullet'; // Always 'bullet' currently
  }
...
// --- editGoogleDoc: Claude-like find and replace tool ---
server.addTool({
  name: 'editGoogleDoc',
  description:
...
async function startServer() {
  try {
    await ensureAccountsInitialized(); // Load configured accounts
