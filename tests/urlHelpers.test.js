...
describe('URL Helpers', () => {
  ...
  describe('getFormsUrl', () => {
    it('should construct a valid Google Forms edit URL', () => {
      ...
      assert.strictEqual(
        url,
        'https://docs.google.com/forms/d/form123/edit?authuser=test%40example.com'
      );
    });
  ...
  describe('getDriveFileUrl', () => {
    it('should construct a valid Google Drive file URL', () => {
      ...
      assert.strictEqual(
        url,
        'https://drive.google.com/file/d/file123/view?authuser=test%40example.com'
      );
    });
  ...
  describe('getGmailMessageUrl', () => {
    it('should construct a valid Gmail message URL', () => {
      ...
      assert.strictEqual(
        url,
        'https://mail.google.com/mail/?authuser=test%40example.com#all/msg123'
      );
    });
  ...
  describe('getGmailThreadUrl', () => {
    it('should construct a valid Gmail thread URL', () => {
      ...
      assert.strictEqual(
        url,
        'https://mail.google.com/mail/?authuser=test%40example.com#all/thread123'
      );
    });
  ...
  describe('getGmailDraftsUrl', () => {
    it('should construct a valid Gmail drafts URL', () => {
      ...
      assert.strictEqual(url, 'https://mail.google.com/mail/?authuser=test%40example.com#drafts');
    });
    ...
    it('should encode special characters in email', () => {
      ...
      assert.strictEqual(
        url,
        'https://mail.google.com/mail/?authuser=test%2Balias%40example.com#drafts'
      );
    });
  });
  ...
  describe('getCalendarUrl', () => {
    it('should construct a valid Calendar view URL', () => {
      ...
      assert.strictEqual(url, 'https://calendar.google.com/calendar/r?authuser=test%40example.com');
    });
  ...
  describe('addAuthUserToUrl', () => {
    it('should add authuser to URL without query params', () => {
      ...
      assert.strictEqual(url, 'https://example.com/path?authuser=test%40example.com');
    });
    ...
    it('should add authuser to URL with existing query params', () => {
      ...
      assert.strictEqual(url, 'https://example.com/path?foo=bar&authuser=test%40example.com');
    });
    ...
    it('should handle URLs with hash fragments', () => {
      ...
      assert.strictEqual(url, 'https://example.com/path?authuser=test%40example.com#section');
    });
